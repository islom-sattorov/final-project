            ...
            <Box sx={bxs}>
                <div className={style.modal_reserve}>
                    ...
                    <div className={style.card_flex}>
                        <button onClick={() => setCard('Mir')}><img className={style.icon} src={mirIcon} alt='icon' /></button>
                        <button onClick={() => setCard('Master')}><img className={style.icon} src={mcIcon} alt='icon' /></button>
                        <button onClick={() => setCard('Milli')}><img className={style.icon} src={milliIcon} alt='icon' /></button>
                    </div>
